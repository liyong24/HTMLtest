...
for(var i = 0; i < canyinbox1Num; i++){
    addBoxBig("../img/jiancai1.png","commodity_about.html","餐饮推荐爆款","毛毛","3922120","北京海淀区健德门环星大厦",".canyinhot1");
}
//餐饮 精品新款
var canyinbox2Num = 9;
if(canyinbox2Num > 9) canyinbox2Num = 9;
for(var i = 0; i < canyinbox2Num; i++){
    addBoxBig("../img/jiancai2.png","commodity_about.html","餐饮精品新款","毛毛","3922120","北京海淀区健德门环星大厦",".canyinhot2");
}
...
for(var i = 0; i < canyinbox3Num; i++){
    addBoxBig("../img/jiancai3.png","commodity_about.html","餐饮推荐配件","毛毛","3922120","北京海淀区健德门环星大厦",".canyinhot3");
}
...
for(var i = 0; i < fushibox1Num; i++){
    addBoxBig("../img/jiancai1.png","commodity_about.html","服饰推荐爆款","毛毛","3922120","北京海淀区健德门环星大厦",".fushihot1");
}
//服饰 精品新款
var fushibox2Num = 9;
if(fushibox2Num > 9) fushibox2Num = 9;
for(var i = 0; i < fushibox2Num; i++){
    addBoxBig("../img/jiancai2.png","commodity_about.html","服饰精品新款","毛毛","3922120","北京海淀区健德门环星大厦",".fushihot2");
}
...
for(var i = 0; i < fushibox3Num; i++){
    addBoxBig("../img/jiancai3.png","commodity_about.html","服饰推荐配件","毛毛","3922120","北京海淀区健德门环星大厦",".fushihot3");
}
