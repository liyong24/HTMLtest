/**
 * Created by liyong on 2017/3/21.
 */
//轮播图初始化
...
for(var i = 0; i < tjNum; i++){
    addBox_tj("one.html","../img/commodity1.png","自家礼包送亲人，送朋友的不二选择","11.8","20.0",".commodity_box_wrap");
}

//轮播图添加数据

addBox_tj("one.html","../img/commodity1.png","自家礼包送亲人，送朋友的不二选择","11.8","20.0",".swiper-slide2");
